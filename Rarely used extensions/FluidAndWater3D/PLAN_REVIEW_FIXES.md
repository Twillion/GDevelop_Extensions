...
- `node "Rarely used extensions/FluidAndWater3D/build-extension.mjs"` rebuilt the extension JSON; all 199 generated JavaScript blocks parsed successfully.
- `node "Rarely used extensions/FluidAndWater3D/test-all.mjs" --webgl` passed the static shader checks, runtime regressions, FFT/ocean checks, SPH checks, generated JSON freshness check, and real WebGL test.
