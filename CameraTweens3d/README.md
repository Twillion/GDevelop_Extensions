...
- **Reads your character behavior directly:** if the object carries a **Physics Character 3D** (or **Physics Car 3D**) behavior, the extension takes ground state, fall speed, forward speed and strafe speed straight from it, instead of guessing from frame-to-frame position.
...
4. **Trigger Action Events:**
   - On shooting: `CameraTweens3D::Apply weapon recoil (Pitch: 3.0, Yaw: 0.5, KickbackZ: 0.04)`
