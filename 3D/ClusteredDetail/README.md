...
## 📂 Extension Files & Documentation

* [`ClusteredDetail.json`](./ClusteredDetail.json) — Importable GDevelop 5 extension file.
* [`ClusteredDetail.runtime.js`](./ClusteredDetail.runtime.js) — WebGL2 clustered decal engine and forward shader injector.
* [`API_REFERENCE.md`](./API_REFERENCE.md) — Complete GDevelop-facing action, condition, expression, and behavior reference.
...
* [`build-extension.mjs`](./build-extension.mjs) — Build script to compile `ClusteredDetail.json`.
...
```sh
# Mathematical formulation and binary GPU packing tests:
node "3D/ClusteredDetail/test-plan-validation.mjs"

# Runtime lifecycle, ring-buffer, broadphase binning, and anchor tracking tests:
node "3D/ClusteredDetail/test-runtime.mjs"

# Headless WebGL2 shader pipeline and pixel validation tests (Chrome / SwiftShader):
node "3D/ClusteredDetail/test-webgl.mjs"

# Rebuild extension JSON:
node "3D/ClusteredDetail/build-extension.mjs"
```
